...
enum {
	...
	NE6X_NLMSG_TEMPL_WRITE,
	NE6X_NLMSG_TEMPL_READ,
	NE6X_NLMSG_MAX,
};
...
struct ne6x_netlink_status {
	u32 data[NE6X_RULE_BATCH_MAX];
	DECLARE_BITMAP(state, NE6X_RULE_BATCH_MAX);
};

struct ne6x_templ_write {
	u32 port_num;
	u32 value;
} __packed;
