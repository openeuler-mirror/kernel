...
#define MEDIA_ONLINE_BIT             BIT(0)
#define MEDIA_FIBRE_BIT              BIT(3)
#define MEDIA_DAC_BIT                BIT(4)
#define MEDIA_TP_BIT                 BIT(5)

#define SPEED_SUPPORT_100M           BIT(0)
#define SPEED_SUPPORT_1G             BIT(1)
#define SPEED_SUPPORT_10G            BIT(2)
#define SPEED_SUPPORT_25G            BIT(3)
#define SPEED_SUPPORT_40G            BIT(4)
#define SPEED_SUPPORT_100G           BIT(5)
#define SPEED_SUPPORT_USER_CHG       BIT(7)

#define MEDIA_SUPPORT_COPPER         BIT(0)
#define MEDIA_SUPPORT_FIBRE          BIT(1)
#define MEDIA_SUPPORT_DAC            BIT(2)

#define FEC_LOW_SPEED_SUPPORT_AUTO   BIT(0)
#define FEC_LOW_SPEED_SUPPORT_RS     BIT(1)
#define FEC_LOW_SPEED_SUPPORT_BASER  BIT(2)

#define FEC_HIGH_SPEED_SUPPORT_AUTO  BIT(4)
#define FEC_HIGH_SPEED_SUPPORT_RS    BIT(5)
#define FEC_HIGH_SPEED_SUPPORT_BASER BIT(6)

struct ne6x_fw_port_info {
	u8 hw_port;
	u8 speed_supported;
	u8 media_supported;
	u8 fec_supported;
...
struct ne6x_fw_info {
	u16 chip_id;
	u16 nb_port;
	struct ne6x_fw_port_info fw_port[8];
