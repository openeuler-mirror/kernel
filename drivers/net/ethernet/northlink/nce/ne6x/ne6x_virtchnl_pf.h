...
static inline int ne6x_set_vf_spoofchk(struct net_device *netdev, int vf_id, bool setting)
{
	return -EOPNOTSUPP;
}

static inline int ne6x_set_vf_bw_for_max_vpnum(struct ne6x_pf *pf, int vf_id, int max_tx_rate)
{
	return -EOPNOTSUPP;
}
