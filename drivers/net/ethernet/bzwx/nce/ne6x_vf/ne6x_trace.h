...
#if !defined(_NE6X_VF_TRACE_H_)
#define _NE6X_VF_TRACE_H_

#define ne6x_trace(trace_name, args...)
#define ne6x_trace_enabled(trace_name) (0)
#endif /* !defined(_NE6X_VF_TRACE_H_) */
#else  /* CONFIG_TRACEPOINTS */
#undef TRACE_SYSTEM
#define TRACE_SYSTEM ne6xvf
...
/* This must be outside ifdef _NE6X_VF_TRACE_H_ */
