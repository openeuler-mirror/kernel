...
#define rnpm_info(fmt, args...) \
	pr_debug("rnpm-info: " fmt, ##args)
#define rnpm_warn(fmt, args...) \
	pr_debug("rnpm-warn: " fmt, ##args)
#define rnpm_err(fmt, args...) pr_debug("rnpm-err : " fmt, ##args)
...
static inline u32 rnpm_vid_crc32_le(uint16_t vid_le)
{
