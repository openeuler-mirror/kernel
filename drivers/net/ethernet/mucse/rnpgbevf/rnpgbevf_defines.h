...
#define RNPGBE_TX_FLAGS_VLAN_CFI_SHIFT 12
	...
	__le16 cmd;
#define RNPGBE_TXD_VLAN_VALID BIT(15)
#define RNPGBE_TXD_SVLAN_TYPE BIT(9)
...
#define RNPGBE_TXD_L4_CSUM BIT(12)
#define RNPGBE_TXD_IP_CSUM BIT(11)
...
#define RNPGBE_TXD_FLAG_IPv6 BIT(5)
#define RNPGBE_TXD_FLAG_TSO BIT(4)
#define RNPGBE_TXD_CMD_RS BIT(2)
#define RNPGBE_TXD_STAT_DD BIT(1)
#define RNPGBE_TXD_CMD_EOP BIT(0)
} __packed;
...
struct rnp_tx_ctx_desc {
	...
	__le16 inner_vlan;
	u8 vf_veb_flags;
#define VF_IGNORE_VLAN BIT(1) /* bit 57 */
#define VF_VEB_MARK BIT(0) /* bit 56 */
	u32 rev;
	__le16 rev1;
	__le16 cmd;
#define RNPGBE_TXD_FLAG_TO_RPU BIT(15)
...
#define RNPGBE_TXD_CTX_CTRL_DESC BIT(3)
#define RNPGBE_TXD_CTX_CMD_RS BIT(2)
#define RNPGBE_TXD_STAT_DD BIT(1)
} __packed;
...
union rnp_rx_desc {
	struct {
		...
		u8 dumy[6];
		__le16 cmd;
#define RNPGBE_RXD_FLAG_RS BIT(2)
	};
	...
	struct {
		...
		__le16 mark;
		__le16 rev1;
#define RNPGBE_RX_L3_TYPE_MASK BIT(15) /* 1 is ipv4 */
#define VEB_VF_PKG BIT(1) /* bit 49 */
#define VEB_VF_IGNORE_VLAN BIT(0) /* bit 48 */
		__le16 len;
		__le16 padding_len;
		__le16 vlan;
		__le16 cmd;
#define RNPGBE_RXD_STAT_VLAN_VALID BIT(15)
...
#define RNPGBE_RXD_STAT_IPV6 BIT(5)
#define RNPGBE_RXD_STAT_IPV4 (0 << 5)
#define RNPGBE_RXD_STAT_PTP BIT(4)
#define RNPGBE_RXD_STAT_DD BIT(1)
#define RNPGBE_RXD_STAT_EOP BIT(0)
	} wb;
} __packed;
...
#define rnpgbevf_dbg(fmt, args...) pr_debug(fmt, ##args)
#define rnpgbevf_info(fmt, args...)                                            \
	pr_debug("rnpgbevf-info: " fmt, ##args)
#define rnpgbevf_warn(fmt, args...)                                            \
	pr_debug("rnpgbevf-warn: " fmt, ##args)
#define rnpgbevf_err(fmt, args...) pr_debug("rnpvf-err : " fmt, ##args)
