...
enum iidc_event_type {
	...
	IIDC_EVENT_CRIT_ERR,
	IIDC_EVENT_PRIO_CHNG,
	IIDC_EVENT_INSMOD,
	IIDC_EVENT_RMMOD,
	IIDC_EVENT_PRIO_MODE_CHNG,
	IIDC_EVENT_FUNC_SIZE_CHNG,
...
#define IIDC_PFC_OFF 0x0
#define IIDC_PFC_ON 0x1
...
struct iidc_core_dev_info {
	...
	char                *pname;
	int                 num_q_vectors;
	struct msix_entry   *p_nic_msix_entries;
	u16 valid_prio; /* 0b00001000 means prio3 valid_prio for rdma */
};
