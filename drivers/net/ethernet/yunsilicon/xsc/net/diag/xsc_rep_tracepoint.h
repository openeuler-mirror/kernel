...
#define _XSC_EN_REP_TP_

#include <linux/tracepoint.h>
#include <linux/trace_seq.h>
#include "xsc_eth_rep.h"

TRACE_EVENT(xsc_rep_neigh_update,
	    TP_PROTO(const struct xsc_neigh_hash_entry *nhe, const u8 *ha,
...
#define TRACE_INCLUDE_FILE xsc_rep_tracepoint
