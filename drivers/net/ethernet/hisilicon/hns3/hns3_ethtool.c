...
static const struct hns3_stats hns3_txq_stats[] = {
	...
	HNS3_TQP_STAT("vlan", tx_vlan_err),
	HNS3_TQP_STAT("l4_proto", tx_l4_proto_err),
	HNS3_TQP_STAT("l2l3l4", tx_l2l3l4_err),
	HNS3_TQP_STAT("tso", tx_tso_err),
};
...
#define HNS3_SELF_TEST_TPYE_NUM		4
