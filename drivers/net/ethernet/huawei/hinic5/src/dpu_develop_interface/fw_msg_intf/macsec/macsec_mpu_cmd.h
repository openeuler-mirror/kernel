 ...
 * @details Operation codes for interaction between MACSEC and driver, involving SC, SA, MIB and SERVICE management
 */
typedef enum {
 ...
 * @details Encryption/decryption side SC operation codes, involving create, delete, update, etc.
 */
typedef enum {
 ...
 * @details Encryption/decryption side SA operation codes, involving create, delete, update, etc.
 */
typedef enum {
 ...
 * @details MACSEC service related operations, such as enabling MACSEC function on driver load, disabling MACSEC function on driver unload
 */
typedef enum {
 ...
 * @details MACSEC feature negotiation related operations, query or set features
 */
typedef enum {
