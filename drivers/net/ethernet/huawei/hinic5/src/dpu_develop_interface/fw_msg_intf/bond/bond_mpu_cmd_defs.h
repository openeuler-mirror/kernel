 ...
 * @details Inherited bond cmd enum type used in 23, mbox message and OVS bonding, see enum tag_ovs_mpu_cmd
 */
enum bond_mpu_cmd {
	MPU_CMD_BOND_CREATE = 17,   /**< Create bond, temporarily keep it to 17 @see struct tag_ovs_bond_cmd */
...
/**
 * bond set attr: variable definitions before bond_name must be consistent with struct bond_attr
 */
