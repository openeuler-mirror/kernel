...
typedef enum {
	...
	BOARD_TYPE_STRG_2X100G_ROCE_SRIOV           = 55,    /**< 2X100GE SmartIO front-end container Card */
	BOARD_TYPE_STRG_2X100G_ROCE_SRIOV_SW        = 56,    /**< 2X100GE SmartIO loopback container Card */
	BOARD_TYPE_STRG_2X200G_ROCE_SRIOV           = 57,    /**< 2X200GE SmartIO front-end container Card */
	...
	BOARD_TYPE_STRG_2X25G_DPU_TIOE              = 62,    /**< 2X25G DPU TIOE Card */
	BOARD_TYPE_STRG_2X200G_DPU_ROCE             = 63,    /**< 2X200G DPU ROCE Card */
	BOARD_TYPE_STRG_4X25G_ROCE_SRIOV            = 76,    /**< 4X25GE SmartIO front-end container Card */
	...
	BOARD_TYPE_CAL_2X25G_NIC_4HOST              = 123,   /**< 2X25GE Tiangong 4HOST standard card */
	...
	BOARD_TYPE_CAL_2X200G_SMARTNIC              = 126,   /**< 2X200G SmartIO Card */
	BOARD_TYPE_CAL_2X200G_NIC_INTERNET          = 127,   /**< 2X200G Internet card */
	BOARD_TYPE_CAL_2X100G_NIC_INTERNET          = 128,   /**< 2X100G Internet card */
	BOARD_TYPE_CAL_1X100GR2_OCP                 = 129,   /**< 1X100GR2 DSFP56 interface OCP Card */
	BOARD_TYPE_CAL_2X200G_DPU                   = 130,   /**< 2X200G DPU Card */
	BOARD_TYPE_CAL_2X100_OCP                    = 131,   /**< 2X100G DSFP56/QSFP56 interface OCP Card */
	BOARD_TYPE_CAL_2X400G_POD                   = 132,   /**< 2X400G UBC 1X8 chip half-width card / 2X8 chip half-width large card */
	BOARD_TYPE_CAL_2X400G_UB_EXP                = 133,   /**< 2X400G A5 Server Card */
	BOARD_TYPE_CAL_2X200G_V2                    = 134,   /**< 2X200G PCIe standard card */
	BOARD_TYPE_CAL_1X400G                       = 135,   /**< 1X400G PCIe standard card */

	BOARD_TYPE_CAL_SP23X_2X10G                  = 136,   /**< 1872 2X10G PCIe standard card */
	BOARD_TYPE_CAL_SP23X_2X25G                  = 137,   /**< 1872 2X25G PCIe standard card */
	BOARD_TYPE_CAL_SP23X_2X100G                 = 138,   /**< 1872 2X100G PCIe standard card */
	BOARD_TYPE_CAL_SP23X_2X100G_OCP             = 139,   /**< 1872 2X100G OCP Card */
	BOARD_TYPE_CAL_SP23X_1X200G                 = 140,   /**< 1872 1X200G PCIe standard card */

	BOARD_TYPE_CAL_2X400G_UBX_BOARD             = 141,   /**< 1825 2X400G UBX BOARD */
	BOARD_TYPE_CAL_2X400G_UB_EXP_V1             = 142,   /**< 1825 2X400G UB EXP custom card */
	...
	BOARD_TYPE_CLD_4X25G_SDI5_0_C               = 175,   /**< 4X25G SDI5.0.C Card */
	BOARD_TYPE_CLD_2X200G_SDI6_1                = 176,   /**< 2X200G SDI6.1 Card */
	BOARD_TYPE_CLD_2X400G_SDI_BOX               = 177,   /**< 2X400G cloud intelligent computing SDI-BOX Card */

	BOARD_TYPE_MAX_INDEX                        = 0xFF,   /**< Maximum value of card */
} board_type_define_e;

#define IS_EVB_BOARD_TYPE(type)                                                         \
	((type) < BOARD_TYPE_STRG_SMARTIO_4X32G_FC) /**< 4X25G SDI5.0.C Card */
#endif
