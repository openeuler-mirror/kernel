...
enum sdk_cmd_type {
	SDK_CMD_SET_FREQ_REDUCE_RATIO = SERVICE_DRV_BASE_CMD,   /**< Set the frequency reduction ratio for chip time statistics */
	SDK_CMD_SET_TIME_DIFF_ENABLE,    /**< Enable chip time difference statistics */
	SDK_CMD_GET_TIME_DIFF,           /**< Get the difference of chip time difference statistics */
	...
	/* SDK tool reserved command words, products use command words in this range */
