 ...
 * Description   : MACsec device entity definitions
 */
...
typedef struct macsec_resource {
	...
	u32 num_of_device;
	himacsec_stats_s *stats;  // Driver internal counters
	struct notifier_block nb;
	u8 function_port;
	u32 offload_child_dev_idx[MACSEC_SC_NUM];  // ifindex of macsec sub-devices; ifindex of offloaded macsec devices is stored in this array
	u32 offload_dev_num;                       // Number of valid elements in the offload_child_dev_idx array
} macsec_resource_s;
