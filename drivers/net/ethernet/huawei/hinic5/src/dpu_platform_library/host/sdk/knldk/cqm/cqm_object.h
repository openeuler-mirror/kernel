 ...
 * File Name     : cqm_object.h
 * Version       : Initial Draft
 * Created       : 2026/5/20
 * Last Modified : 2026/09/16
 * Description   : CQM object management header
 */
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_queue *cqm5_object_fc_srq_create(void *ex_handle, u32 service_type,
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_queue *cqm5_object_recv_queue_create(void *ex_handle, u32 service_type,
						   enum cqm_object_type object_type,
 ...
 * @date: 2019-5-4
 */
s32 cqm5_object_srq_add_container_free(struct tag_cqm_queue *common, u8 **container_addr);
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_queue *cqm5_object_share_recv_queue_create(void *ex_handle,
							 u32 service_type,
							 enum cqm_object_type object_type,
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_qpc_mpt *cqm5_object_qpc_mpt_create(void *ex_handle, u32 service_type,
						  enum cqm_object_type object_type,
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_queue *cqm5_object_nonrdma_queue_create(void *ex_handle, u32 service_type,
						      enum cqm_object_type object_type,
						      u32 wqe_number, u32 wqe_size,
						      void *object_priv);
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_queue *cqm5_object_rdma_queue_create(void *ex_handle, u32 service_type,
						   enum cqm_object_type object_type,
						   u32 object_size, void *object_priv,
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_mtt_rdmarc *cqm5_object_rdma_table_get(void *ex_handle, u32 service_type,
						     enum cqm_object_type object_type,
 ...
 * @date: 2019-5-4
 */
u8 *cqm5_object_offset_addr(struct tag_cqm_object *object, u32 offset, dma_addr_t *paddr);
 ...
 * @date: 2019-5-4
 */
struct tag_cqm_object *cqm5_object_get(void *ex_handle, enum cqm_object_type object_type,
				      u32 index, bool bh);
 ...
 * @date: 2019-5-4
 */
void cqm5_srq_used_rq_container_delete(struct tag_cqm_object *object, u8 *container);
...
/**
 * @brief: ring direct wqe db for fc
 * @details: ring direct wqe db for fc
 * @param ex_handle: device pointer that represents the PF
 * @param service_type: service type
 * @param direct_wqe: direct wqe to be written
 * @retval: s32, 0 for success, others for failure
 */
