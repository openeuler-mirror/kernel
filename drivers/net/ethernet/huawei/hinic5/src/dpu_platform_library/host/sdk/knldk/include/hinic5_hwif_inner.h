 ...
 * Description   : HINIC5 hardware interface inner header file
 */
...
#ifdef __UEFI__
	void *bus_dev; /* represents pdev in pcie scenario, represents ub dev in ub scenario */
#endif
	void *hwdev;
...
/**
 * @brief Define a function pointer type for handling AEQ interrupts
