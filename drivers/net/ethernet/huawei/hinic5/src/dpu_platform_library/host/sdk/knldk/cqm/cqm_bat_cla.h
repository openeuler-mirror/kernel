 ...
 * File Name     : cqm_bat_cla.h
 * Version       : Initial Draft
 * Created       : 2026/5/20
 * Last Modified : 2026/09/16
 * Description   : CQM BAT and CLA table management header
 */
...
struct tag_cqm_cla_table {
	...
	struct tag_cqm_object_table obj_table; /* Mapping table between
						* indexes and objects
						*/
	struct cqm_mem_addr secure_mem; /* Secure memory with consecutive physical addresses */
...
struct tag_cqm_bat_table {
	...
	struct cqm_secure_mem_info func_secure_mem;
...
u8 *cqm_cla_get(struct tag_cqm_handle *cqm_handle, struct tag_cqm_cla_table *cla_table,
