 ...
 * Description   : MACsec DFX (debug) entity definitions
 */
...
#define HIMACSEC_DRV_VER "100.0.2.101"
...
void himacsec_dfx_show_sa(struct hinic5_nic_dev *nic_dev, macsec_sa_info_s *sa_info, crypt_direction_e direct);
void himacsec_dfx_show_sc(struct hinic5_nic_dev *nic_dev, macsec_sc_info_s *sc_info, crypt_direction_e direct);
