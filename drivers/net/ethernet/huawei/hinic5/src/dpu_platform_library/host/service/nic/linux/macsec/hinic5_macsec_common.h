 ...
 * Description   : MACsec common definitions
 */
...
#define MACSEC_GLOBAL_SWITCH_IS_DISABLE 0 /* Used to check whether the MACsec global switch is on; if on, it affects NIC services */
