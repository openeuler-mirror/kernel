 ...
 * Description   : Hardware API definitions for the hinic5 driver.
 */
...
struct hinic5_csr_request_api_data {
	u32 dw0;
...
enum HINIC5_CSR_API_DATA_OPERATION_ID {
	HINIC5_CSR_OPERATION_WRITE_CSR = 0x1E,
	HINIC5_CSR_OPERATION_READ_CSR = 0x1F
};

enum HINIC5_CSR_API_DATA_NEED_RESPONSE_DATA {
	HINIC5_CSR_NO_RESP_DATA = 0,
	HINIC5_CSR_NEED_RESP_DATA = 1
};

enum HINIC5_CSR_API_DATA_DATA_SIZE {
	HINIC5_CSR_DATA_SZ_32 = 0,
	HINIC5_CSR_DATA_SZ_64 = 1
};
