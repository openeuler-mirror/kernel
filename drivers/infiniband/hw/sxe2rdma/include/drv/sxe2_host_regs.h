...
#define SXE2_TXQ_CONTEXT0(_pf_idx)	(0x10040 + ((_pf_idx) * 0x100))
#define SXE2_TXQ_CONTEXT1(_pf_idx)	(0x10044 + ((_pf_idx) * 0x100))
#define SXE2_TXQ_CONTEXT2(_pf_idx)	(0x10048 + ((_pf_idx) * 0x100))
#define SXE2_TXQ_CONTEXT3(_pf_idx)	(0x1004C + ((_pf_idx) * 0x100))
#define SXE2_TXQ_CONTEXT4(_pf_idx)	(0x10050 + ((_pf_idx) * 0x100))
#define SXE2_TXQ_CONTEXT7(_pf_idx)	(0x1005C + ((_pf_idx) * 0x100))
...
#define SXE2_TXQ_CTRL(_pf_idx)          (0x10064 + ((_pf_idx) * 0x100))
#define SXE2_TXQ_CTXT_CTRL(_pf_idx)     (0x100C8 + ((_pf_idx) * 0x100))
#define SXE2_TXQ_DIS_CNT(_pf_idx)       (0x100D0 + ((_pf_idx) * 0x100))
...
#define SXE2_VF_VRC_VFGEN_VFRSTAT_MASK \
	(BIT(2))
#define SXE2_VF_VRC_VFGEN_VFRSTAT_FORVF \
	(0x300)
#define SXE2_VF_VRC_VFGEN_VFRSTAT_FORVF_NO_VFR \
	(0)
#define SXE2_VF_VRC_VFGEN_VFRSTAT_FORVF_VFR (1)
#define SXE2_VF_VRC_VFGEN_VFRSTAT_FORVF_MASK \
	(BIT(10))
...
#define PFP_CGM_TX_TXHI(_port, _i) \
	(CGMAC_CSR_BASE + CGMAC_PORT_OFFSET * (_port) + 0x108 + ((_i) * 8))
#define PFP_CGM_TX_TXLO(_port, _i) \
	(CGMAC_CSR_BASE + CGMAC_PORT_OFFSET * (_port) + 0x10C + ((_i) * 8))
