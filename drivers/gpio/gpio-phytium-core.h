...
#define GPIO_RAW_INTSTATUS	0x2c
/* RO Port A Raw Interrupt Status Register */
#define GPIO_LS_SYNC		0x30
/* WR Level-sensitive Synchronization Enable Register */
...
int phytium_gpio_direction_output(struct gpio_chip *gc,
