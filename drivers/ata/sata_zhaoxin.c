...
static const unsigned int zx_bar_sizes[] = { 8, 4, 8, 4, 16, 256 };

static const unsigned int zx100s_bar_sizes0[] = { 8, 4, 8, 4, 16, 0 };

static const unsigned int zx100s_bar_sizes1[] = { 8, 4, 0, 0, 16, 0 };

static int zx_prepare_host(struct pci_dev *pdev, struct ata_host **r_host)
{
	const struct ata_port_info *ppi0[] = { &zx100s_port_info, NULL };
	const struct ata_port_info *ppi1[] = { &zx100s_port_info, &ata_dummy_port_info };
